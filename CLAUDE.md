...
- **Retro-attivazione Founder**: lucone (id 1328, #1) e riccardocampagnari (id 1329, #2) sono stati promossi a Founder retroattivamente da script SSH. Marker: `cart.wp_order_id < 0` (es. -5, -6) identifica le retro-attivazioni — utile escluderle dai conteggi di "vendita del team" (solo sul proprio cart).
