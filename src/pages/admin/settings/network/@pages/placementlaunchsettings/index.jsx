      ...
      <DataHandlerList dataProps={{ ...dataProps }}>
        ...
        <Table>
          <TableHead>
            <TableRow>
              <TableCell>
                <Translate>settings.network.months</Translate>
              </TableCell>
...
const Row = ({ id, bonus_amount, months,rank, handleUpdate }) => {
  return (
    <TableRow>
       <TableCell>
        <LoadingTextField
...
export default Placementlaunchsettings;
