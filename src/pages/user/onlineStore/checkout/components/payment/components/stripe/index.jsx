...
const CheckoutForm = () => {
  ...
  const { is_subscription, is_package } = usePurchaseData();
  ...
  const handleSubmit = async (event) => {
    ...
    const { error } = await stripe.confirmPayment({
      elements,
      confirmParams: {
        return_url: `${window.origin}/verify-payment?purchase_id=${userPayment}&recurring=${isRecurring}&subscription=${is_subscription}`,
      },
    });
    if (error) {
