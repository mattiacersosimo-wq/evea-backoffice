...
const useHigherRank = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const { status, data } = await fetchUser("affiliate-dashboard/eveolving-Progressbar");
        if (status === 200) {
...
const EvolvingBonus = () => {
  ...
  return (
    <BonusWidget
      ...
      color="#FF5722"
      title={t("user_dashboard.eveolving_bonus")}
    >
