    ...
    <Box sx={{ mt: 2 }}>
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1.5 }}>
        <Stack direction="row" alignItems="center" spacing={1}>
          <Iconify icon="mdi:swap-horizontal" width={20} sx={{ color: "#7B1FA2" }} />
          <Typography sx={{ fontSize: "0.9rem", fontWeight: 700, color: ESPRESSO }}>Livelli Matching</Typography>
        </Stack>
                ...
                <Stack direction="row" alignItems="center" spacing={1.5}>
                  ...
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    <Stack direction="row" alignItems="center" justifyContent="space-between" mb={0.3}>
                      <Stack direction="row" alignItems="center" spacing={1}>
                        <Typography sx={{ fontSize: "0.78rem", fontWeight: 700, color: ESPRESSO }}>Livello {level.level}</Typography>
                        <Typography sx={{ fontSize: "0.68rem", color: "#7A6A5C" }}>{users.length} utent{users.length === 1 ? "e" : "i"}</Typography>
                        <Chip label={RM_PCT[level.level] || "10%"} size="small"
