...
const useHigherRank = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const { status, data } = await fetchUser("affiliate-dashboard/isb-Progressbar");
        if (status === 200) {
...
const IndirectSalesBonus = () => {
  ...
  return (
    <BonusWidget
      ...
      color="#00BCD4"
      title={t("user_dashboard.indirect_sales_bonus")}
    >
...
export default IndirectSalesBonus;
