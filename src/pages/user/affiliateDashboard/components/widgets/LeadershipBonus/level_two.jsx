...
const Level_Two = ({ level_two = [] }) => {
  ...
  const customers = level_two?.customers || [];
  if (!customers.length) return <Typography sx={{ fontSize: "0.75rem", color: "#aaa", py: 1 }}>{t("bonus_widgets.leadership.no_leader_gen", { n: 2, defaultValue: "Nessun leader in Gen 2" })}</Typography>;
