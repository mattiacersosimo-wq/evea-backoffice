...
import Level_Two_BV_Users from "./level_two_BV_users";
...
const Level_Two = ({ level_two = [], state }) => {
    ...
    <>
      ...
      >
        <Typography variant="subtitle1">
          {t("affiliate_dashboard.generation_2")}
        </Typography>
        <IconButton
        ...
        <Card sx={{ pt: 1, mt: 2 }}>
          <Scrollbar>
            <DataHandlerTable
              ...
              dataProps={{
                ...dataProps,
                isArrayEmpty: !level_two?.customers?.length,
              }}
            >
              <Map
                list={level_two?.customers}
                render={(item, i) => (
                  <>
